...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=2000&pause=500&color=667EEA&center=true&vCenter=true&repeat=true&width=500&height=60&lines=🤖+AI+Chat+Assistant;🌤️+Weather+Intelligence;📸+Food+Scanner;👨‍🍳+Cooking+Mode;🛒+Smart+Cart" alt="Typing SVG" />
</p>
...
[![Gemini AI](https://img.shields.io/badge/Gemini_AI-2.0-4285F4?logo=google)](https://ai.google.dev)

[Features](#-features) • [Setup](#-quick-start) • [Tech Stack](#-tech-stack) • [API](#-api-documentation)
...
### 👨‍🍳 Cooking Mode
- Step-by-step recipes from Firebase
...
### ️ Smart Menu & Cart
- Browse with filters (category, cuisine, dietary)
- Real-time cart with Firebase sync
- Quantity management
- Price calculation
